    ...
    public class PlayerMovement : MonoBehaviour
    {
        ...
        public void HandleMovement(float delta)
        {
            ...
            if (inputHandler.sprintFlag)
            {
                ...
                animatorHandler.UpdateAnimatorValues(2, 0, playerManager.isSprinting);
            }
            else
            {
        ...
        public void HandleFalling(float delta, Vector3 moveDirection)
        {
            ...
            if (Physics.Raycast(origin, myTransform.forward, out hit, groundDirectionRayDistance, ignoreForGroundCheck))
            {
